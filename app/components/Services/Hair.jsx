        ...
        <div className='service'>
            <div className='px-6'>
                ...
                <div className='border-t border-black pt-2'>
                    <div className='flex w-full justify-between text-xl font-medium px-2 mb-4'>
                        <h3>Dry cut</h3>
                        <h3>£12.00</h3>
                    </div>
                    <div className='flex w-full justify-between text-xl font-medium px-2 mb-4'>
                ...
                <div className='w-full flex justify-center pb-[calc(6vh+4rem)] mt-8'><h4 className='border border-black py-2 px-4 font-semibold tracking-wider text-lg'>Book appoinment</h4></div>
            </div>
        </div>
    </div>
  )
