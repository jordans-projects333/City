...
const Showcase = ({showcase, slider, serviceTabsWrapper, treatments, setOnService}) => {
    ...
    return (
        <div ref={showcase} className="fixed left-[100%] top-[6vh] w-full h-[100vh] z-10 lg:absolute bg-white overflow-y-scroll">
            <div className='service w-full bg-black text-white flex items-center justify-center gap-2 pr-4 py-1 border-t-2 border-black' onTouchStart={() => showcaseOut()}>
