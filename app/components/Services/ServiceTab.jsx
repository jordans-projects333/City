...
const serviceTab = ({showcaseIn, imageRef, src, wrapperRef, treatmentType}) => {
  return (
    <div className="flex-1 lg:h-[100%] relative">
        <div ref={wrapperRef} className="relative overflow-hidden h-full lg:h-[70%]" onTouchStart={(e) => showcaseIn(e, treatmentType)} onMouseDown={(e) => showcaseIn(e, treatmentType)}>
