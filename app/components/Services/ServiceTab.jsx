...
const serviceTab = ({showcaseIn, imageRef, src, wrapperRef, treatmentType, title, number, serviceText}) => {
  return (
    <div className="flex-1 lg:h-[100%] relative">
        <div ref={wrapperRef} className="relative overflow-hidden h-full lg:h-[70%]" onClick={(e) => showcaseIn(e, treatmentType)}>
            ...
            <div ref={serviceText} className='bg-black/20 absolute h-full w-full flex flex-col items-center justify-center duration-300'>
